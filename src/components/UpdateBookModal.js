          ...
          <Modal.Body>
            <Form onSubmit={this.handleSubmit}>
              ...
              <FloatingLabel className="mb-3" controlId="floatingInput" label="Update Description">
                <Form.Control type="text" defaultValue={this.props.selected.description} placeholder="Enter a description for this book" name="description" required />
              </FloatingLabel>
              <Form.Group className="mb-3" controlId="formBasicCheckbox">
                <Form.Check name="read" defaultChecked={this.props.selected.read} type="checkbox" label="Book has been read" />
              </Form.Group>
